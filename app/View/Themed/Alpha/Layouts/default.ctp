...
<html lang="en">
    <head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-71925930-4"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'UA-71925930-4');
		</script>
        ...
        <meta name="author" content="Liberty Lending">
        <title>Liberty Lending</title>
		              ...
		              <div class="container-fluid">
		                ...
		                <div class="collapse navbar-collapse" id="ws_navbar">
		                  <ul class="nav navbar-nav navbar-right">
		                    ...
		                    <li><a href="https://global.leadstudio.com/privacy?site=Liberty%20Lending%20Exchange" data-title="Privacy Policy" data-toggle="lightbox" data-gallery="remoteload"><span class="glyphicon glyphicon-eye-open"></span> Privacy</a></li>
		...
		<div id="ws_pghd_wrap">
			<div class="container">
		    	<div class="row">
		        	<div class="col-sm-12">
		            	<div id="ws_logo">
		                <?php echo $this->Html->image('ll_logo.png', array('alt'=>'LibertyLendingExchange', 'class'=>'img-responsive', 'width'=>'324', 'height'=>'61', 'url'=>'/')); ?>
		                </div>
		                <div id="ws_tag">
