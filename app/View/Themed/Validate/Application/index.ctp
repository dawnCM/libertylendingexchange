	...
	<div class="container">
    	...
    	<div class="row">
        	<div class="col-sm-12">
                ...
                <?php 
                if($this->Session->read('Application.AppType') == 'payday'){
                	echo 'Lenders online now with up to <span class="orng">$1,000</span> to deposit in your account by <span class="orng">tomorrow!</span>';
                }else{
	              ...
	              <div class="tab-content <?php echo $this->Session->read('Application.AppType');?>">
	                  <div class="tab-pane tab1" id="tab1">
	                    ...
	                    <div class="row">
							...
							<input name="Email" data-trigger="focus" data-container="body" data-toggle="popover-info" data-placement="top" data-title="Email Validation" data-content="To better protect your identity, we will send a validation code to the email address you provide." type="email" class="form-control" id="Email" tabindex="7" size="20" maxlength="50"  value="<?php echo $this->Session->read('Application.Email'); ?>" placeholder="Email" 
							data-parsley-required="true" 
