...
class ApplicationController extends AppController {
	...
	public function beforeFilter() {
		...
		$this->Session->write('Application.Campaign_id', '5a0a8e64c1aeb');
		$this->Session->write('Application.Campaign_key', 'Q6kNm4b7ZvVMwt2hW8Kr');
	...
	public function index() {
		...
		//print_r($this->Session->read('Application'));die();
