...
class AppController extends Controller {
	...
	protected function buildAncillaryPops(){
		...
		$cache['hash'] = md5('AncillaryPops_3');
		$cache['value'] = false;
		$cache['value'] = Cache::read($cache['hash']);
